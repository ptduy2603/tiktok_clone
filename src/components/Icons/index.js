// components cho svg file
const MessageIcon = ({ className, width = '3.2rem', height = '3.2rem', color = 'currentColor' }) => {
    return (
        <svg
            className={className}
            width={width}
...
const InboxIcon = ({ className, width = '3.2rem', height = '3.2rem', color = 'currentColor' }) => {
    return (
        <svg
            className={className}
            width={width}
...
const HomeIcon = ({ width = '3.2rem', height = '3.2rem', className, color = 'currentColor' }) => {
    return (
        <svg
            width={width}
            className={className}
...
const HomeActiveIcon = ({ width = '3.2rem', height = '3.2rem', className, color = 'currentColor' }) => {
    return (
        <svg
            width={width}
            data-e2e=""
...
const UserGroupActiveIcon = ({ width = '3.2rem', height = '3.2rem', className, color = 'currentColor' }) => {
    return (
        <svg
            width={width}
            className={className}
...
const UserGroupIcon = ({ width = '3.2rem', height = '3.2rem', className, color = 'currentColor' }) => {
    return (
        <svg
            width={width}
            data-e2e=""
...
const LiveIcon = ({ width = '3.2rem', height = '3.2rem', className, color = 'currentColor' }) => {
    return (
        <svg
            width={width}
            data-e2e=""
...
const LiveActiveIcon = ({ width = '3.2rem', height = '3.2rem', className, color = 'currentColor' }) => {
    return (
        <svg
            width={width}
            className={className}
